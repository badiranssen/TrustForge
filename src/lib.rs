...
#[derive(Debug)]
pub struct TrustForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TrustForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TrustForge processing");
    
    let mut processor = TrustForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TrustForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TrustForgeProcessor::new(false);
